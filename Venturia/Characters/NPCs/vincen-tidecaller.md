---
title: Vincen Tidecaller
description: 'Master of the Tidekeeper''s Lodge holding his Autumn Council seat by ancient charter — a quiet voice warning that the strangeness in the water is older than the city''s commerce.'
published: true
date: 2026-05-22T00:00:00.000Z
tags: characters, npcs, autumn-council, tidekeepers-lodge, human
editor: markdown
...
<div style="font-family: 'Cinzel', Georgia, serif; font-size: 2rem; letter-spacing: 0.08em; color: #d4a574; line-height: 1.1; margin-bottom: 0.75rem; text-transform: uppercase;">Vincen Tidecaller</div>
...
<div><span style="color: #8b7355; letter-spacing: 0.18em; text-transform: uppercase; font-size: 0.7rem; font-weight: 600;">Seat</span> &nbsp;&middot;&nbsp; Master of the Tidekeeper's Lodge</div>
...
<div><span style="color: #8b7355; letter-spacing: 0.18em; text-transform: uppercase; font-size: 0.7rem; font-weight: 600;">Age</span> &nbsp;&middot;&nbsp; 60s</div>
</div>
<div style="margin-top: 1.25rem; padding-left: 1rem; border-left: 2px solid rgba(212, 165, 116, 0.4); font-style: italic; color: rgba(212, 165, 116, 0.9); font-family: 'IM Fell English', Georgia, serif; font-size: 1rem;">"It's older than your warehouses and your trade routes."</div>
</div>

<div style="flex-shrink: 0;">
<img src="/images/character-art/Vincen.png" alt="Vincen Tidecaller" style="width: 240px; max-width: 100%; border-radius: 4px; box-shadow: 0 10px 36px rgba(0, 0, 0, 0.8); border: 1px solid rgba(139, 115, 85, 0.5);">
</div>

</div>

Master of the [Tidekeeper's Lodge](/en/Venturia/Factions/tidekeepers-lodge), holding his Autumn Council seat by ancient charter rather than wealth. A quiet man in his sixties with a permanent horizon-squint, he speaks rarely and is listened to when he does, carrying generations of accumulated Tidekeeper knowledge. He cares more for the Lodge's independence than for politics.
...
- **[The Tidekeeper's Lodge](/en/Venturia/Factions/tidekeepers-lodge)** — The order he leads.
