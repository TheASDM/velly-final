...
## Connections
- **Marcello / Lorenzo** — His death breaks the prison lock.
- **The Keeper of Faces** — The imprisoned entity that would be freed.
- **Tartuzi** — Marcello's death also frees her from millennia of enslavement.
- **[The Three Fanes](/en/Venturia/DM/three-fanes)** — Destroying all three is the prerequisite for defeating Marcello.
