...
<div style="font-family: 'Cinzel', Georgia, serif; font-size: 2rem; letter-spacing: 0.08em; color: #d4a574; line-height: 1.1; margin-bottom: 0.75rem; text-transform: uppercase;">The Burnt Quill</div>
...
<div style="margin-top: 1.25rem; padding-left: 1rem; border-left: 2px solid rgba(212, 165, 116, 0.4); font-style: italic; color: rgba(212, 165, 116, 0.9); font-family: 'IM Fell English', Georgia, serif; font-size: 1rem;">"Recording what Venturia chooses to remember"</div>
</div>

<div style="flex-shrink: 0;">
<img src="/images/locations/burnt-quill.png" alt="The Burnt Quill" style="width: 280px; aspect-ratio: 4 / 3; object-fit: cover; max-width: 100%; border-radius: 4px; box-shadow: 0 10px 36px rgba(0, 0, 0, 0.8); border: 1px solid rgba(139, 115, 85, 0.5);">
</div>
...
More valuable than the presses is the **morgue** — the Quill's archive of back issues, clippings, and unpublished notes stretching back to the paper's founding.
...
## The Two Kinds of Reporter

| Type | Reputation | Approach |
|---|---|---|
| **The Principled** | Unimpeachable integrity | Pursues stories wherever they lead, regardless of consequence |
| **The Discreet** | Reliability of a different kind | Knows when to stop asking questions; understands some truths are more valuable kept quiet than published |
...
- Reporter who pursued a story too far
- Morgue librarian who knows exactly what's been removed
