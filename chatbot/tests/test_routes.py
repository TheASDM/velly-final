...
/api/admin/lore-submissions/<submission_id>/draft|/api/admin/lore-submissions/missing/draft|POST|admin_lore_submission_redraft|401:json.error,error_code|403:json.error,error_code|404:json.error|404:json.error
/api/admin/lore-submissions/<submission_id>/publish|/api/admin/lore-submissions/missing/publish|POST|admin_lore_submission_publish|401:json.error,error_code|403:json.error,error_code|404:json.error|404:json.error
/api/admin/lore-submissions/<submission_id>/reject|/api/admin/lore-submissions/missing/reject|POST|admin_lore_submission_reject|401:json.error,error_code|403:json.error,error_code|404:json.error|404:json.error
/api/admin/lore-submissions/<submission_id>/save|/api/admin/lore-submissions/missing/save|POST|admin_lore_submission_save|401:json.error,error_code|403:json.error,error_code|404:json.error|404:json.error
/api/admin/messages|/api/admin/messages|GET|admin_messages|401:json.error,error_code|403:json.error,error_code|200:json.messages|200:json.messages
/api/admin/messages/<int:message_id>|/api/admin/messages/1|DELETE|dm_message_delete|401:json.error,error_code|403:json.error,error_code|404:json.error|404:json.error
/api/admin/rebuild|/api/admin/rebuild|GET|admin_rebuild|401:json.error,error_code|403:json.error,error_code|200:json.rebuild|200:json.rebuild
...
/api/admin/wiki-entry|/api/admin/wiki-entry|GET|admin_wiki_entry|401:json.error,error_code|403:json.error,error_code|404:json.error|404:json.error
/api/admin/wiki-pages|/api/admin/wiki-pages|GET|admin_wiki_pages|401:json.error,error_code|403:json.error,error_code|200:json.pages|200:json.pages
...
/api/gallery/<gallery_id>|/api/gallery/missing|DELETE|gallery_delete|401:json.error,error_code|403:json.error,error_code|400:json.error|400:json.error
...
/api/internal/im-test-message|/api/internal/im-test-message|POST|im_internal_test_message|400:json.error,error_code|400:json.error,error_code|400:json.error,error_code|400:json.error,error_code
...
/api/rumors/<int:rumor_id>|/api/rumors/1|DELETE|rumors_delete|401:json.error,error_code|403:json.error,error_code|200:json.deleted,ok|404:json.error
