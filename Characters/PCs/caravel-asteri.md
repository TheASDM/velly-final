...
description: A nineteen-year-old Satyr Bard apprenticed to the Masquers' Sodality — Venturia-born, finished with secrets, and tied to the Covenant Archive family they walked away from.
published: true
...
<img src="https://codex.valleyofshadows.wiki/images/character-art/car.png" alt="Caravel 'Car' Asteri" style="width: 240px; max-width: 100%; border-radius: 4px; box-shadow: 0 10px 36px rgba(0, 0, 0, 0.8); border: 1px solid rgba(139, 115, 85, 0.5);">
</div>
...
## Family
Car's parents run [The Covenant Archive](/en/Venturia/Locations/covenant-archive), the house where the city's deals are sealed and kept. There's a twin sister — the "perfect" one, the favored one — and a long family friendship with the owners of [The Burnt Quill](/en/Venturia/Locations/burnt-quill). Car rejected the family trade.
