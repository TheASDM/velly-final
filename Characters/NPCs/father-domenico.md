...
# Father Domenico of the Four Winds

**Seat:** Temple Authority &nbsp;|&nbsp; **Represents:** Smaller temples &amp; wandering clergy &nbsp;|&nbsp; **Race:** Human &nbsp;|&nbsp; **Age:** Late 30s &nbsp;|&nbsp; *"Venturia's prosperity came from somewhere."*

<div style="text-align: center; margin: 1.5rem 0 2rem;">
<img src="https://codex.valleyofshadows.wiki/images/character-art/domenico.png" alt="Father Domenico of the Four Winds" style="width: 280px; max-width: 80%; border-radius: 4px; box-shadow: 0 8px 32px rgba(0,0,0,0.7); border: 1px solid rgba(139,115,85,0.3);">
</div>
