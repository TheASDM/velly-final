...
class LoreMasterChatbot {
    ...
    // Consume the SSE response, rendering tokens into a live bubble as
    // they arrive. Returns the same shape as the JSON path plus a
    // _streamed flag so send() knows the bubble's already on-screen.
